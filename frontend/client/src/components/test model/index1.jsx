...
const connectWebSocket = () => {
  ...
  socket.onopen = async () => {
    nonce = await web3.eth.getTransactionCount(station1, 'pending');
  ...
  socket.onmessage = async (event) => {
    ...
    const customSent = { id: iid, status:isFault, negative:n1, positive:p2, blockHash:sent.blockHash, blockNumber: sent.blockNumber, transactionHash: sent.transactionHash, gasUsed: sent.gasUsed };
    // updating the states
